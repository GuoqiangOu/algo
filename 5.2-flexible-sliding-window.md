...
| 9   | <span style="color: orange;">Medium</span> 1656 | [1004. Max Consecutive Ones III](https://leetcode.com/problems/max-consecutive-ones-iii/)                                                       | #flexible-sliding-window | <input type="checkbox">         |
| 10  | <span style="color: orange;">Medium</span> 1817 | [1658. Minimum Operations to Reduce X to Zero](https://leetcode.com/problems/minimum-operations-to-reduce-x-to-zero/)                           | #flexible-sliding-window | <input type="checkbox">         |
